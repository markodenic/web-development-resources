...
| Website                                                                               | Description                                                                                                                                                                           |
|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Gradienty](https://gradienty.codes/)                                                 | An all-in-one Tailwind & CSS toolkit for Animations, Gradients, Mesh Gradients, Glassmorphism, Box Shadow, Text Gradients, Blobs & Color Palettes.                                                                                                                                                  |
