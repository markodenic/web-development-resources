...
| [FastDevTool](https://fastdevtool.com)                                           | 50+ free developer utilities — JSON formatter/beautifier, Base64, URL encoder, JWT decoder, Regex, UUID, Hash, SQL formatter and more. Monaco editor (VS Code engine), offline PWA, shareable URLs via client-side compression. |
